...
static struct MapData maps[] = {
    ...
    { "dns-fragment.txt", 6, 1, 1368, 4994, 0 },
    ...
    { "light-fragment.txt", 13, 1, 1628, 5580, 0 },
    { "light-vertex.txt", 14, 1, 167, 227, 0 },
    { "lightvolume-fragment.txt", 15, 1, 477, 1004, 0 },
    { "occlusion-fragment.txt", 16, 1, 530, 1116, 0 },
    { "occlusion-vertex.txt", 17, 1, 211, 350, 0 },
    { "overlay-fragment.txt", 18, 1, 446, 1277, 0 },
    { "overlay-vertex.txt", 19, 1, 359, 924, 0 },
